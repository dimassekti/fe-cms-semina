...
export const fetchListCategories = () => {
  return async (dispatch) => {
    ...
    try {
      let res = await debouncedFetchListsCategories("/v1/cms/categories");
...
export const fetchListTalents = () => {
  return async (dispatch) => {
    ...
    try {
      let res = await debouncedFetchListsTalents("/v1/cms/talents");
...
export const fetchListEvents = () => {
  return async (dispatch) => {
    ...
    try {
      let res = await debouncedFetchListsEvents("/v1/cms/events");
